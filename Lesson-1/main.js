...
// PUT YOUR CODE HERE
const floatingPoint = 0.234, integer = 420, negative = -3, notANumber = 4 + " i tried", bigNumber = ["lets play with Big Numbers", 12 ** 12, "<-This is only 13 wow!", "One more try", 13 ** 13, "<--only 2 more digits", "Sorry sir for you suffering through my failures but this is fun!!", 4 ** 42, "finally broke through to scientific numbers"]
console.log(
...
// STRETCH GOAL: For this stretch goal, make a second variable that still concatenates your variable from Q1, but uses template literals.^^^^<--was gonna do it this way anyways, just easier.-^_^-
...
// const floatingPoint = 0.234, integer = 420, negative = -3
...
/*
i will probaly ask you in person but just incase i forget, why dont you guys suggest devDocs for help with documentaion? 

yeah i had to go research this, minus one was a trick my old TA showed me.
*/

//first name method operation
const length = firstName.length;
const firstInitial = firstName[0];
const lastInitial = firstName[length-1]
const capitalize = firstName.toUpperCase()
//last name method operation
